...
func TestTerraformAzureVmExample(t *testing.T) {
	...
	testVMsize(t, terraformOptions, subscriptionID)
...
func testVMsize(t *testing.T, terraformOptions *terraform.Options, subscriptionID string) {
	// Run `terraform output` to get the values of output variables.
	resourceGroupName := terraform.Output(t, terraformOptions, "resource_group_name")
	virtualMachineName := terraform.Output(t, terraformOptions, "vm_name")
	expectedVMSize := terraform.Output(t, terraformOptions, "vm_size")
	...
	actualVMSizeString := string(actualVMSize)
	assert.Equal(t, expectedVMSize, actualVMSizeString)
}
...
func testDisksOfVM(t *testing.T, terraformOptions *terraform.Options, subscriptionID string) {
	...
	actualDiskTypeString := string(actualDiskType)
	assert.Equal(t, expectedDiskType, actualDiskTypeString)
}
